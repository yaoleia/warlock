<template>
    <div class="debug">
        ...
        <div class="right-content">
            ...
            <imgStream class="detect-main" v-show="activeName=='main'" @loaded="loaded('main')" :url="`${serverUrl}/detect/video_feed_main`"></imgStream>
            <imgStream class="detect-assist" v-show="activeName=='assist'" @loaded="loaded('assist')" :url="`${serverUrl}/detect/video_feed_usb`"></imgStream>
        </div>
    </div>
</template>
