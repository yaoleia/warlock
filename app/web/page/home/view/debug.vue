<template>
	<div class="debug">
		...
		<div class="right-content">
			...
			<imgStream v-if="activeName=='main'" :url="`${serverUrl}/detect/video_feed_main`"></imgStream>
			<imgStream v-if="activeName=='assist'" :url="`${serverUrl}/detect/video_feed_usb`"></imgStream>
		</div>
	</div>
</template>
<style lang="scss">
